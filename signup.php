                ...
                <div class="col p-5 mb-4 mt-4">
                    ...
                    <form action="" method="POST">
                        <div class="form-group">
                            <label for="tenTK">Tên Đăng Kí</label>
                        ...
                        <button type="submit" class=" border-0 btn-cust text-center text-white mb-3 w-100 mx-auto" value="LOGIN">Đăng Kí</button>
...
135deg,#f75959 0%,#f35587 100%);">
                    <div>
                        ...
                        <a href="login.php" class="btn btn-outline-danger" style="color: white;
    border-color: white;">Đăng nhập</a>
                    </div>
                </div>
            </div>
        </div>
